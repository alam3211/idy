...
{% block content %}
                ...
                <div class="content" id="vue-app">
                    ...
                    <h2 class="content-heading bottom-marginless">Tambah Pertanyaan Kuisioner Mata Kuliah</h2>
                    <p class="text-danger">*Semua isian wajib diisi!</p>

                    <div class="block">
                        <form action="{{ url(['for':'ipd-admin-matkul-update']) }}" method="post">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">
                                    Pertanyaan Kuisioner Mata Kuliah
                                </h3>
                            </div>
                            ...
                            <div class="block-header block-header-default">
                                <h3 class="block-title">
                                    Pilihan Jawaban Kuisioner Mata Kuliah
                                </h3>
                            </div>
                            <div class="block-content bottom-padding-15">
                            ...
                            <div class="col-md-12 row bottom-padding-15">
                                <div class="col-md-6">
                                    <button type="button" onclick="window.location.href=`{{ url(['for':'ipd-admin-matkul-list']) }}`" class="btn btn-outline-secondary col-md-12">Batalkan</button>
                                </div>
                                <div class="col-md-6">
...
{% block additional_scripts %}
    <script>
        ...
        $("#sidebar-matkul-create").addClass("active");
    </script>
{% endblock %}